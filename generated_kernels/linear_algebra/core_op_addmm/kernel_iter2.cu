...
#include <pybind11/pybind11.h> // Required for py::arg
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    // Modify the binding to include default arguments for beta_d and alpha_d,
    // as PyTorch's aten::addmm takes them as optional and defaults to 1.0.
